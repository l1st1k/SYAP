...
number_to_flip_input = browser.find_element(by=By.ID, value='numberToFlip')
number_to_flip_input.send_keys('9999999999999999')
flip_button = browser.find_element(by=By.ID, value='btn_flipNumber')
flip_button.click()
