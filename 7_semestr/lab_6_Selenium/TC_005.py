...
numbers = browser.find_element(by=By.ID, value='numbers')
numbers.send_keys('1, 1, 2, 3, 4, 4, 5, 2')
flip_button = browser.find_element(by=By.ID, value='btn_removeDuplicates')
flip_button.click()
